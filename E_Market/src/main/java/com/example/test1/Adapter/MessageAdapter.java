...
public class MessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MessageAdapter(Context context, List<MessagesDetails> messages) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        MessagesDetails message = messages.get(position);
        if (holder instanceof ViewHolder) {
            ...
            if (message.getType().contains("image")){
                if (message.getText().isEmpty()){
                    ...
                    Picasso.get().load(message.getImage()).into(((ViewHolder) holder).ivImage);
                }else{
            ...
            if (message.getType().contains("image")){
                if (message.getText().isEmpty()){
                    ...
                    Picasso.get().load(message.getImage()).into(((SenderVH) holder).ivImage);
                }else{
                    //if type is image and text is also not empty
